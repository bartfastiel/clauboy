...
import { startPolling, stopPolling, startActivityPolling, stopActivityPolling } from './polling'
...
async function startupSync(): Promise<void> {
  try {
    ...
    // Restore persisted state so we don't lose containerId, etc. across restarts
